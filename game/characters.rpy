...
define sounds2 = ['audio/cow/Samuel_O.wav','audio/cow/Samuel_E.wav','audio/cow/Samuel_A.wav','audio/cow/Samuel_B.wav','audio/cow/Samuel_I.wav','audio/cow/Samuel_U.wav']
...
define sounds4 = ['audio/rabbit/cr1.wav','audio/rabbit/cr2.wav','audio/rabbit/cr3.wav','audio/rabbit/cr4.wav','audio/rabbit/cr5.wav','audio/rabbit/cr6.wav','audio/rabbit/cr7.wav','audio/rabbit/cr8.wav']
define sounds5 = ['audio/frog/c1.wav','audio/frog/c3.wav','audio/frog/c4.wav','audio/frog/c5.wav','audio/frog/c7.wav','audio/frog/c8.wav','audio/frog/c9.wav']
define sounds6 = ['audio/magpie/N-01.wav','audio/magpie/N-02.wav','audio/magpie/N-03.wav','audio/magpie/N-04.wav','audio/magpie/N-05.wav','audio/magpie/N-07.wav','audio/magpie/N-08.wav','audio/magpie/N-09.wav','audio/magpie/N-10.wav','audio/magpie/N-11.wav']
...
init python:
    ...
    def type_sound4(event, interact=True, **kwargs):
        if not interact:
            return

        if event == "show": #if text's being written by character, spam typing sounds until the text ends
            renpy.sound.play(renpy.random.choice(sounds4))
            renpy.sound.queue(renpy.random.choice(sounds4))
            renpy.sound.queue(renpy.random.choice(sounds4))
            renpy.sound.queue(renpy.random.choice(sounds4))
            renpy.sound.queue(renpy.random.choice(sounds4))
            renpy.sound.queue(renpy.random.choice(sounds4))
...
init python:
    ...
    def type_sound5(event, interact=True, **kwargs):
        if not interact:
            return

        if event == "show": #if text's being written by character, spam typing sounds until the text ends
            renpy.sound.play(renpy.random.choice(sounds5))
            renpy.sound.queue(renpy.random.choice(sounds5))
            renpy.sound.queue(renpy.random.choice(sounds5))
            renpy.sound.queue(renpy.random.choice(sounds5))
            renpy.sound.queue(renpy.random.choice(sounds5))
            renpy.sound.queue(renpy.random.choice(sounds5))
...
init python:
    ...
    def type_sound6(event, interact=True, **kwargs):
        if not interact:
            return

        if event == "show": #if text's being written by character, spam typing sounds until the text ends
            renpy.sound.play(renpy.random.choice(sounds6))
            renpy.sound.queue(renpy.random.choice(sounds6))
            renpy.sound.queue(renpy.random.choice(sounds6))
            renpy.sound.queue(renpy.random.choice(sounds6))
            renpy.sound.queue(renpy.random.choice(sounds6))
            renpy.sound.queue(renpy.random.choice(sounds6))
...
define cow = Character("Cooper the Cow",color="415ed9", callback=type_sound2)
define badger = Character("Billy the Badger",color="eda05c",callback=type_sound3)
define rabbit = Character("Ruby the Rabbit",color="dbb7c2",callback=type_sound4)
define snake = Character("Sheldon the Snake")
define magpie = Character("Maggie the Magpie",color="e9c531",callback=type_sound6)
define frog = Character("Freddie the Frog",color="788a38",callback=type_sound5)
